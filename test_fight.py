...
# 1. Start by copying test_base() and replace the enemy in Fight() to the desired one
# 2. Uncomment player.draw_pile for a custom draw_pile, and uncomment random.seed(69420) to predetermined every random move
# 3. Run the script, ensure that the behavior is as intended while playing and remember the input sequence and give it as an argument to captured_std()
# 4. Uncomment captured_std() and indent the line under it
# 5. Re-run the script, copy and paste the big string and assign it to expected
# 6. Remove the print(repr(output)) line, run the script and you should have a passing test!

# TODO tests
# death no HP
# death no HP by spider after match
# EncounterAcolyte()
# Bossfight()
# tigerE
# swanE
